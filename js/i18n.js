...
const TRANSLATIONS = {
  en: {
    ...
    'Instalação profissional de raiz ou em substituição de equipamento existente. Trabalhamos com Daikin, Bosch, Daitsu e Samsung, aproveitando a infraestrutura sempre que possível.': 'Professional installation from scratch or replacing existing equipment. We work with Daikin, Bosch, Daitsu and Samsung, making use of existing infrastructure whenever possible.',
    ...
    'Ar condicionado Daikin, Bosch, Daitsu e Samsung — 77 modelos disponíveis com especificações técnicas.': 'Daikin, Bosch, Daitsu and Samsung air conditioning — 77 models available with technical specifications.',
    ...
    'Revendedores autorizados Daikin, Bosch, Daitsu e Samsung em climatização, e Bosch em painéis solares AQS.': 'Authorised dealers of Daikin, Bosch, Daitsu and Samsung in air conditioning, and Bosch for solar water heating.',
    ...
    '24 anos de prática': '24 years of hands-on experience',
    ...
    'Inovação WindFree™': 'WindFree™ Innovation',
    'A Samsung reinventou o conforto com a tecnologia WindFree™ — arrefece sem criar correntes de ar frio direto. Com Wi-Fi SmartThings integrado, sensor de movimento radar e filtro PM2.5, é a escolha certa para quem quer conforto real.': 'Samsung reinvented comfort with WindFree™ technology — it cools without creating direct cold air currents. With built-in Wi-Fi SmartThings, a radar motion sensor and PM2.5 filter, it\'s the right choice for those who want real comfort.',
    '✓ WindFree™ — sem correntes de ar frio direto': '✓ WindFree™ — no direct cold air currents',
    '✓ Wi-Fi SmartThings integrado de série': '✓ Built-in Wi-Fi SmartThings as standard',
    '✓ Sensor de Movimento Radar (Première+)': '✓ Radar Motion Sensor (Première+)',
    '✓ Filtro PM2.5 + auto-limpeza Freeze Wash': '✓ PM2.5 filter + Freeze Wash self-cleaning',
    'Ideal para: quem sofre com ar frio direto, utilizadores de domótica Samsung': 'Ideal for: those sensitive to direct cold air, Samsung smart home users',
    'WindFree™ sem correntes de ar frio': 'WindFree™ without cold air currents',
    ...
    'Exterior': 'Outdoor unit',
    'Filtro básico': 'Basic filter',
    'Auto-restart': 'Auto-restart',
    'Modo I-Feel': 'I-Feel mode',
    'WiFi integrado': 'Integrated WiFi',
    'Purificador de ar': 'Air purifier',
    'App Daikin Online': 'Daikin Online App',
    'Design icónico': 'Iconic design',
    '8 cores disponíveis': '8 colours available',
    'Tecido Azul': 'Blue Fabric',
    'Tecido Cinzento': 'Grey Fabric',
    'Pele Castanha': 'Brown Leather',
    'Madeira Clara': 'Light Wood',
    'Madeira Escura': 'Dark Wood',
    '3 cores disponíveis': '3 colours available',
    'Auto-limpeza iClean': 'iClean self-cleaning',
    'Super Ionizador': 'Super Ionizer',
    'Golden Fin anticorrosivo': 'Golden Fin anti-corrosion',
    'Ionizador': 'Ionizer',
    'Sensor de movimento': 'Motion sensor',
    'Sensor de presença': 'Presence sensor',
    'Ionizador avançado': 'Advanced ionizer',
    'WiFi incluído': 'WiFi included',
    'WiFi opcional (acessório)': 'Optional WiFi (accessory)',
    'Quer o módulo WiFi para controlo por app? (acessório, custo adicional)': 'Do you want the WiFi module for app control? (accessory, additional cost)',
    'Sim, quero o módulo WiFi': 'Yes, I want the WiFi module',
    'Não, obrigado': 'No, thanks',
    'Por favor indique se quer o módulo WiFi.': 'Please indicate if you want the WiFi module.',
    'Módulo WiFi (acessório): ': 'WiFi module (accessory): ',
    'Sim': 'Yes',
    'Não': 'No',
    'I Feel': 'I Feel',
    'IA+': 'AI+',
    ...
    'Compare as 4 marcas para esta configuração': 'Compare all 4 brands for this setup',
    'Melhor Preço': 'Best Price',
    'Selecionada': 'Selected',
    'Ver esta opção →': 'View this option →',
    'Objetivo da instalação': 'Installation goal',
    'Instalação de equipamento novo com pré-instalação': 'New equipment installation with existing pre-installation',
    'Substituição do equipamento antigo': 'Replacement of old equipment',
    'Instalação do equipamento sem pré-instalação': 'Equipment installation without pre-installation',
    'Por favor indique o objetivo da instalação.': 'Please indicate the installation goal.',
    'Objetivo: ': 'Goal: ',
    'Exterior: ': 'Outdoor: ',
    ...
    'Configure as suas divisões': 'Set up your rooms',
    'Sistema configurado ✓': 'System configured ✓',
    'Preencha os dados de pelo menos uma divisão antes de gerar o PDF.': 'Please fill in the data for at least one room before generating the PDF.',
  ...
  fr: {
    ...
    'Instalação profissional de raiz ou em substituição de equipamento existente. Trabalhamos com Daikin, Bosch, Daitsu e Samsung, aproveitando a infraestrutura sempre que possível.': 'Installation professionnelle de zéro ou en remplacement d\'équipement existant. Nous travaillons avec Daikin, Bosch, Daitsu et Samsung, en utilisant l\'infrastructure existante autant que possible.',
    ...
    'Ar condicionado Daikin, Bosch, Daitsu e Samsung — 77 modelos disponíveis com especificações técnicas.': 'Climatisation Daikin, Bosch, Daitsu et Samsung — 77 modèles disponibles avec spécifications techniques.',
    ...
    'Revendedores autorizados Daikin, Bosch, Daitsu e Samsung em climatização, e Bosch em painéis solares AQS.': 'Revendeurs agréés Daikin, Bosch, Daitsu et Samsung en climatisation, et Bosch pour panneaux solaires ECS.',
    ...
    '24 anos de prática': '24 ans d\'expérience pratique',
    ...
    'Inovação WindFree™': 'Innovation WindFree™',
    'A Samsung reinventou o conforto com a tecnologia WindFree™ — arrefece sem criar correntes de ar frio direto. Com Wi-Fi SmartThings integrado, sensor de movimento radar e filtro PM2.5, é a escolha certa para quem quer conforto real.': 'Samsung a réinventé le confort avec la technologie WindFree™ — elle refroidit sans créer de courants d\'air froid direct. Avec le Wi-Fi SmartThings intégré, un capteur de mouvement radar et un filtre PM2.5, c\'est le bon choix pour ceux qui veulent un vrai confort.',
    '✓ WindFree™ — sem correntes de ar frio direto': '✓ WindFree™ — sans courants d\'air froid direct',
    '✓ Wi-Fi SmartThings integrado de série': '✓ Wi-Fi SmartThings intégré de série',
    '✓ Sensor de Movimento Radar (Première+)': '✓ Capteur de mouvement radar (Première+)',
    '✓ Filtro PM2.5 + auto-limpeza Freeze Wash': '✓ Filtre PM2.5 + auto-nettoyage Freeze Wash',
    'Ideal para: quem sofre com ar frio direto, utilizadores de domótica Samsung': 'Idéal pour : ceux sensibles aux courants d\'air froid, utilisateurs de domotique Samsung',
    'WindFree™ sem correntes de ar frio': 'WindFree™ sans courants d\'air froid',
    ...
    'Filtro básico': 'Filtre basique',
    'Auto-restart': 'Redémarrage automatique',
    'Modo I-Feel': 'Mode I-Feel',
    'WiFi integrado': 'WiFi intégré',
    'Purificador de ar': 'Purificateur d\'air',
    'App Daikin Online': 'App Daikin Online',
    'Design icónico': 'Design iconique',
    '8 cores disponíveis': '8 couleurs disponibles',
    'Tecido Azul': 'Tissu Bleu',
    'Tecido Cinzento': 'Tissu Gris',
    'Pele Castanha': 'Cuir Marron',
    'Madeira Clara': 'Bois Clair',
    'Madeira Escura': 'Bois Foncé',
    '3 cores disponíveis': '3 couleurs disponibles',
    'Auto-limpeza iClean': 'Auto-nettoyage iClean',
    'Super Ionizador': 'Super Ioniseur',
    'Golden Fin anticorrosivo': 'Golden Fin anticorrosion',
    'Ionizador': 'Ioniseur',
    'Sensor de movimento': 'Capteur de mouvement',
    'Sensor de presença': 'Détecteur de présence',
    'Ionizador avançado': 'Ioniseur avancé',
    'WiFi incluído': 'WiFi inclus',
    'WiFi opcional (acessório)': 'WiFi en option (accessoire)',
    'Quer o módulo WiFi para controlo por app? (acessório, custo adicional)': 'Voulez-vous le module WiFi pour le contrôle par application ? (accessoire, coût supplémentaire)',
    'Sim, quero o módulo WiFi': 'Oui, je veux le module WiFi',
    'Não, obrigado': 'Non, merci',
    'Por favor indique se quer o módulo WiFi.': 'Veuillez indiquer si vous voulez le module WiFi.',
    'Módulo WiFi (acessório): ': 'Module WiFi (accessoire) : ',
    'Sim': 'Oui',
    'Não': 'Non',
    'I Feel': 'I Feel',
    'IA+': 'IA+',
    ...
    'Compare as 4 marcas para esta configuração': 'Comparez les 4 marques pour cette configuration',
    'Melhor Preço': 'Meilleur Prix',
    'Selecionada': 'Sélectionnée',
    'Ver esta opção →': 'Voir cette option →',
    'Objetivo da instalação': 'Objectif de l\'installation',
    'Instalação de equipamento novo com pré-instalação': 'Installation d\'un équipement neuf avec pré-installation existante',
    'Substituição do equipamento antigo': 'Remplacement de l\'ancien équipement',
    'Instalação do equipamento sem pré-instalação': 'Installation de l\'équipement sans pré-installation',
    'Por favor indique o objetivo da instalação.': 'Veuillez indiquer l\'objectif de l\'installation.',
    'Objetivo: ': 'Objectif : ',
    'Exterior: ': 'Unité extérieure : ',
    ...
    'Configure as suas divisões': 'Configurez vos pièces',
    'Sistema configurado ✓': 'Système configuré ✓',
    'Preencha os dados de pelo menos uma divisão antes de gerar o PDF.': 'Veuillez renseigner les données d\'au moins une pièce avant de générer le PDF.',
  ...
  es: {
    ...
    'Instalação profissional de raiz ou em substituição de equipamento existente. Trabalhamos com Daikin, Bosch, Daitsu e Samsung, aproveitando a infraestrutura sempre que possível.': 'Instalación profesional desde cero o en sustitución de equipos existentes. Trabajamos con Daikin, Bosch, Daitsu y Samsung, aprovechando la infraestructura siempre que sea posible.',
    ...
    'Ar condicionado Daikin, Bosch, Daitsu e Samsung — 77 modelos disponíveis com especificações técnicas.': 'Aire acondicionado Daikin, Bosch, Daitsu y Samsung — 77 modelos disponibles con especificaciones técnicas.',
    ...
    'Revendedores autorizados Daikin, Bosch, Daitsu e Samsung em climatização, e Bosch em painéis solares AQS.': 'Revendedores autorizados de Daikin, Bosch, Daitsu y Samsung en climatización, y Bosch en paneles solares ACS.',
    ...
    '24 anos de prática': '24 años de práctica',
    ...
    'Inovação WindFree™': 'Innovación WindFree™',
    'A Samsung reinventou o conforto com a tecnologia WindFree™ — arrefece sem criar correntes de ar frio direto. Com Wi-Fi SmartThings integrado, sensor de movimento radar e filtro PM2.5, é a escolha certa para quem quer conforto real.': 'Samsung reinventó el confort con la tecnología WindFree™ — enfría sin crear corrientes de aire frío directo. Con Wi-Fi SmartThings integrado, sensor de movimiento radar y filtro PM2.5, es la elección correcta para quienes quieren confort real.',
    '✓ WindFree™ — sem correntes de ar frio direto': '✓ WindFree™ — sin corrientes de aire frío directo',
    '✓ Wi-Fi SmartThings integrado de série': '✓ Wi-Fi SmartThings integrado de serie',
    '✓ Sensor de Movimento Radar (Première+)': '✓ Sensor de movimiento radar (Première+)',
    '✓ Filtro PM2.5 + auto-limpeza Freeze Wash': '✓ Filtro PM2.5 + autolimpieza Freeze Wash',
    'Ideal para: quem sofre com ar frio direto, utilizadores de domótica Samsung': 'Ideal para: quienes sufren con el aire frío directo, usuarios de domótica Samsung',
    'WindFree™ sem correntes de ar frio': 'WindFree™ sin corrientes de aire frío',
    ...
    'Filtro básico': 'Filtro básico',
    'Auto-restart': 'Reinicio automático',
    'Modo I-Feel': 'Modo I-Feel',
    'WiFi integrado': 'WiFi integrado',
    'Purificador de ar': 'Purificador de aire',
    'App Daikin Online': 'App Daikin Online',
    'Design icónico': 'Diseño icónico',
    '8 cores disponíveis': '8 colores disponibles',
    'Tecido Azul': 'Tejido Azul',
    'Tecido Cinzento': 'Tejido Gris',
    'Pele Castanha': 'Piel Marrón',
    'Madeira Clara': 'Madera Clara',
    'Madeira Escura': 'Madera Oscura',
    '3 cores disponíveis': '3 colores disponibles',
    'Auto-limpeza iClean': 'Autolimpieza iClean',
    'Super Ionizador': 'Super Ionizador',
    'Golden Fin anticorrosivo': 'Golden Fin anticorrosivo',
    'Ionizador': 'Ionizador',
    'Sensor de movimento': 'Sensor de movimiento',
    'Sensor de presença': 'Sensor de presencia',
    'Ionizador avançado': 'Ionizador avanzado',
    'WiFi incluído': 'WiFi incluido',
    'WiFi opcional (acessório)': 'WiFi opcional (accesorio)',
    'Quer o módulo WiFi para controlo por app? (acessório, custo adicional)': '¿Quiere el módulo WiFi para control por app? (accesorio, coste adicional)',
    'Sim, quero o módulo WiFi': 'Sí, quiero el módulo WiFi',
    'Não, obrigado': 'No, gracias',
    'Por favor indique se quer o módulo WiFi.': 'Por favor indique si quiere el módulo WiFi.',
    'Módulo WiFi (acessório): ': 'Módulo WiFi (accesorio): ',
    'Sim': 'Sí',
    'Não': 'No',
    'I Feel': 'I Feel',
    'IA+': 'IA+',
    ...
    'Compare as 4 marcas para esta configuração': 'Compare las 4 marcas para esta configuración',
    'Melhor Preço': 'Mejor Precio',
    'Selecionada': 'Seleccionada',
    'Ver esta opção →': 'Ver esta opción →',
    'Objetivo da instalação': 'Objetivo de la instalación',
    'Instalação de equipamento novo com pré-instalação': 'Instalación de equipo nuevo con preinstalación existente',
    'Substituição do equipamento antigo': 'Sustitución del equipo antiguo',
    'Instalação do equipamento sem pré-instalação': 'Instalación del equipo sin preinstalación',
    'Por favor indique o objetivo da instalação.': 'Por favor indique el objetivo de la instalación.',
    'Objetivo: ': 'Objetivo: ',
    'Exterior: ': 'Exterior: ',
    ...
    'Configure as suas divisões': 'Configure sus habitaciones',
    'Sistema configurado ✓': 'Sistema configurado ✓',
    'Preencha os dados de pelo menos uma divisão antes de gerar o PDF.': 'Por favor rellene los datos de al menos una habitación antes de generar el PDF.',
  ...
  de: {
    ...
    'Instalação profissional de raiz ou em substituição de equipamento existente. Trabalhamos com Daikin, Bosch, Daitsu e Samsung, aproveitando a infraestrutura sempre que possível.': 'Professionelle Installation von Grund auf oder als Ersatz vorhandener Geräte. Wir arbeiten mit Daikin, Bosch, Daitsu und Samsung und nutzen vorhandene Infrastruktur wo möglich.',
    ...
    'Ar condicionado Daikin, Bosch, Daitsu e Samsung — 77 modelos disponíveis com especificações técnicas.': 'Daikin, Bosch, Daitsu und Samsung Klimaanlagen — 77 Modelle mit technischen Daten.',
    ...
    'Revendedores autorizados Daikin, Bosch, Daitsu e Samsung em climatização, e Bosch em painéis solares AQS.': 'Autorisierte Händler von Daikin, Bosch, Daitsu und Samsung für Klimaanlagen sowie Bosch für Solarthermie.',
    ...
    '24 anos de prática': '24 Jahre praktische Erfahrung',
    ...
    'Inovação WindFree™': 'WindFree™ Innovation',
    'A Samsung reinventou o conforto com a tecnologia WindFree™ — arrefece sem criar correntes de ar frio direto. Com Wi-Fi SmartThings integrado, sensor de movimento radar e filtro PM2.5, é a escolha certa para quem quer conforto real.': 'Samsung hat den Komfort mit der WindFree™-Technologie neu erfunden — sie kühlt, ohne direkte Kaltluftströme zu erzeugen. Mit integriertem Wi-Fi SmartThings, Radar-Bewegungssensor und PM2.5-Filter ist sie die richtige Wahl für alle, die echten Komfort wollen.',
    '✓ WindFree™ — sem correntes de ar frio direto': '✓ WindFree™ — keine direkten Kaltluftströme',
    '✓ Wi-Fi SmartThings integrado de série': '✓ Wi-Fi SmartThings serienmäßig integriert',
    '✓ Sensor de Movimento Radar (Première+)': '✓ Radar-Bewegungssensor (Première+)',
    '✓ Filtro PM2.5 + auto-limpeza Freeze Wash': '✓ PM2.5-Filter + Freeze Wash Selbstreinigung',
    'Ideal para: quem sofre com ar frio direto, utilizadores de domótica Samsung': 'Ideal für: alle, die unter direkter Kaltluft leiden, Samsung Smart Home-Nutzer',
    'WindFree™ sem correntes de ar frio': 'WindFree™ ohne Kaltluftströme',
    ...
    'Filtro PM2.5': 'PM2.5-Filter',
    'Exterior': 'Außeneinheit',
    'Filtro básico': 'Basisfilter',
    'Auto-restart': 'Automatischer Neustart',
    'Modo I-Feel': 'I-Feel Modus',
    'WiFi integrado': 'Integriertes WLAN',
    'Purificador de ar': 'Luftreiniger',
    'App Daikin Online': 'Daikin Online App',
    'Design icónico': 'Ikonisches Design',
    '8 cores disponíveis': '8 Farben erhältlich',
    'Tecido Azul': 'Blauer Stoff',
    'Tecido Cinzento': 'Grauer Stoff',
    'Pele Castanha': 'Braunes Leder',
    'Madeira Clara': 'Helles Holz',
    'Madeira Escura': 'Dunkles Holz',
    '3 cores disponíveis': '3 Farben erhältlich',
    'Auto-limpeza iClean': 'iClean Selbstreinigung',
    'Super Ionizador': 'Super-Ionisator',
    'Golden Fin anticorrosivo': 'Golden Fin Korrosionsschutz',
    'Ionizador': 'Ionisator',
    'Sensor de movimento': 'Bewegungssensor',
    'Sensor de presença': 'Anwesenheitssensor',
    'Ionizador avançado': 'Erweiterter Ionisator',
    'WiFi incluído': 'WLAN inklusive',
    'WiFi opcional (acessório)': 'WLAN optional (Zubehör)',
    'Quer o módulo WiFi para controlo por app? (acessório, custo adicional)': 'Möchten Sie das WLAN-Modul für die App-Steuerung? (Zubehör, zusätzliche Kosten)',
    'Sim, quero o módulo WiFi': 'Ja, ich möchte das WLAN-Modul',
    'Não, obrigado': 'Nein, danke',
    'Por favor indique se quer o módulo WiFi.': 'Bitte geben Sie an, ob Sie das WLAN-Modul möchten.',
    'Módulo WiFi (acessório): ': 'WLAN-Modul (Zubehör): ',
    'Sim': 'Ja',
    'Não': 'Nein',
    'I Feel': 'I Feel',
    'IA+': 'KI+',
    ...
    'desde ': 'ab ',
    'Compare as 4 marcas para esta configuração': 'Vergleichen Sie alle 4 Marken für diese Konfiguration',
    'Melhor Preço': 'Bester Preis',
    'Selecionada': 'Ausgewählt',
    'Ver esta opção →': 'Diese Option ansehen →',
    'Objetivo da instalação': 'Ziel der Installation',
    'Instalação de equipamento novo com pré-instalação': 'Installation eines neuen Geräts mit vorhandener Vorinstallation',
    'Substituição do equipamento antigo': 'Austausch des alten Geräts',
    'Instalação do equipamento sem pré-instalação': 'Installation des Geräts ohne Vorinstallation',
    'Por favor indique o objetivo da instalação.': 'Bitte geben Sie das Ziel der Installation an.',
    'Objetivo: ': 'Ziel: ',
    ...
    'Configure as suas divisões': 'Konfigurieren Sie Ihre Räume',
    'Sistema configurado ✓': 'System konfiguriert ✓',
    'Preencha os dados de pelo menos uma divisão antes de gerar o PDF.': 'Bitte füllen Sie die Daten für mindestens einen Raum aus, bevor Sie das PDF erstellen.',
