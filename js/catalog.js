...
const PRODUCTS = [
  ...
  { id:'bosch-3000i-26', brand:'bosch', series:'Climate 3000i', model:'CL3000i-Set 26 WE',
    ...
    colors:[{name:'Branco',hex:'#EFEFEF'}], pvp:898,
  ...
  { id:'bosch-3000i-35', brand:'bosch', series:'Climate 3000i', model:'CL3000i-Set 35 WE',
    ...
    tech:['Inverter','R-32','Matter'],
    features:['Função iClean (56°C)','Follow-Me','Filtro anti-bactérias','Alexa / Google Home / Siri'],
    colors:[{name:'Branco',hex:'#EFEFEF'}], pvp:978,
    image:IMG.bosch3000i[0], images:IMG.bosch3000i },
  { id:'bosch-3000i-53', brand:'bosch', series:'Climate 3000i', model:'CL3000i-Set 53 WE',
    ...
    tech:['Inverter','R-32','Matter'],
    features:['Função iClean (56°C)','Follow-Me','Filtro anti-bactérias','Alexa / Google Home / Siri'],
    colors:[{name:'Branco',hex:'#EFEFEF'}], pvp:1439,
    image:IMG.bosch3000i[0], images:IMG.bosch3000i },
  { id:'bosch-3000i-70', brand:'bosch', series:'Climate 3000i', model:'CL3000i-Set 70 WE',
    ...
    tech:['Inverter','R-32','Matter'],
    features:['Função iClean (56°C)','Follow-Me','Filtro anti-bactérias','Alexa / Google Home / Siri'],
    colors:[{name:'Branco',hex:'#EFEFEF'}], pvp:1747,
    image:IMG.bosch3000i[0], images:IMG.bosch3000i },
  ...
  { id:'bosch-3200i-26', brand:'bosch', series:'Climate 3200i', model:'CL3200i-Set 26 WE',
    ...
    tech:['Inverter','R-32','Matter'],
    features:['Função iClean (56°C)','Follow-Me','Filtro anti-bactérias','Alexa / Google Home / Siri'],
    colors:[{name:'Branco',hex:'#EFEFEF'}], pvp:933, isNew:true, awards:['assets/products/award-bosch-3200i-german-design-2026.jpg'],
  ...
  { id:'bosch-3200i-35', brand:'bosch', series:'Climate 3200i', model:'CL3200i-Set 35 WE',
    ...
    tech:['Inverter','R-32','Matter'],
    features:['Função iClean (56°C)','Follow-Me','Filtro anti-bactérias','Alexa / Google Home / Siri'],
    colors:[{name:'Branco',hex:'#EFEFEF'}], pvp:1013, isNew:true, awards:['assets/products/award-bosch-3200i-german-design-2026.jpg'],
    image:IMG.bosch3200i[0], images:IMG.bosch3200i },
  { id:'bosch-3200i-53', brand:'bosch', series:'Climate 3200i', model:'CL3200i-Set 53 WE',
    btu:18000, kw:5.3, energyCool:'A++', energyHeat:'A+', noiseIn:33, noiseOut:57,
    tech:['Inverter','R-32','Matter'],
    features:['Função iClean (56°C)','Follow-Me','Filtro anti-bactérias','Alexa / Google Home / Siri'],
    colors:[{name:'Branco',hex:'#EFEFEF'}], pvp:1474, isNew:true, awards:['assets/products/award-bosch-3200i-german-design-2026.jpg'],
    image:IMG.bosch3200i[0], images:IMG.bosch3200i },
  { id:'bosch-3200i-70', brand:'bosch', series:'Climate 3200i', model:'CL3200i-Set 70 WE',
    btu:24000, kw:7.0, energyCool:'A++', energyHeat:'A+', noiseIn:38, noiseOut:60,
    tech:['Inverter','R-32','Matter'],
    features:['Função iClean (56°C)','Follow-Me','Filtro anti-bactérias','Alexa / Google Home / Siri'],
    colors:[{name:'Branco',hex:'#EFEFEF'}], pvp:1782, isNew:true, awards:['assets/products/award-bosch-3200i-german-design-2026.jpg'],
    image:IMG.bosch3200i[0], images:IMG.bosch3200i },
  ...
  { id:'bosch-6000i-26', brand:'bosch', series:'Climate 6000i', model:'CL6000i-Set 26 WE',
    ...
    colors:[{name:'Branco',hex:'#EFEFEF'}], pvp:1082,
  ...
  { id:'bosch-6000i-35', brand:'bosch', series:'Climate 6000i', model:'CL6000i-Set 35 WE',
    ...
    tech:['Inverter','R-32','WiFi integrado','Matter'],
    features:['Ionizador integrado','Sensor de presença','Controlo de humidade','Filtro avançado','Alexa / Google Home / Siri'],
    colors:[{name:'Branco',hex:'#EFEFEF'}], pvp:1193,
    image:IMG.bosch6000i[0], images:IMG.bosch6000i },
  { id:'bosch-6000i-53', brand:'bosch', series:'Climate 6000i', model:'CL6000i-Set 53 WE',
    ...
    tech:['Inverter','R-32','WiFi integrado','Matter'],
    features:['Ionizador integrado','Sensor de presença','Controlo de humidade','Filtro avançado','Alexa / Google Home / Siri'],
    colors:[{name:'Branco',hex:'#EFEFEF'}], pvp:1784,
    image:IMG.bosch6000i[0], images:IMG.bosch6000i },
  { id:'bosch-6000i-70', brand:'bosch', series:'Climate 6000i', model:'CL6000i-Set 70 WE',
    ...
    tech:['Inverter','R-32','WiFi integrado','Matter'],
    features:['Ionizador integrado','Sensor de presença','Controlo de humidade','Filtro avançado','Alexa / Google Home / Siri'],
    colors:[{name:'Branco',hex:'#EFEFEF'}], pvp:2177,
    image:IMG.bosch6000i[0], images:IMG.bosch6000i },
